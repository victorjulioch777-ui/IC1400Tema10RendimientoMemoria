...
almacenamiento. Los niveles más cercanos al procesador presentan menores
tiempos de acceso, mientras que los niveles inferiores ofrecen una mayor
capacidad a costa de una latencia superior. Por esta razón, los sistemas
modernos utilizan memorias caché para atender parte de las solicitudes sin
tener que acceder directamente a la memoria principal
\cite{park2022dvfs}.
...
\subsubsection{Latencia y tiempo de acceso}
...
\subsubsection{Relación entre latencia y ancho de banda}
...
\subsubsection{Memory wall y memory stalls}
...
rendimiento de los sistemas computacionales. Alawneh et al. señalan que,
a pesar de los avances en la arquitectura de los procesadores, la latencia
de acceso a DRAM no ha disminuido significativamente durante las últimas
décadas. En sistemas multinúcleo, además, la competencia entre varios núcleos
por los bancos de memoria compartidos puede generar contención y aumentar
los retrasos asociados con los accesos a memoria
